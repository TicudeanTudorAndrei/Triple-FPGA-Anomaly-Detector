...
HD_PWD='E:/VivadoProjects/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_proj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_proj.tcl
