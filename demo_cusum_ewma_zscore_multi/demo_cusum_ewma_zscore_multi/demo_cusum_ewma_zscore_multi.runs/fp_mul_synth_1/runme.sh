...
HD_PWD='E:/VivadoProjects/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi.runs/fp_mul_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_mul.tcl
