...
OPTRACE "link_design" START { }
  link_design -top top_level_proj -part xc7a100tcsg324-1 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force top_level_proj_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file top_level_proj_drc_opted.rpt -pb top_level_proj_drc_opted.pb -rpx top_level_proj_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force top_level_proj_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file top_level_proj_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file top_level_proj_utilization_placed.rpt -pb top_level_proj_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file top_level_proj_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force top_level_proj_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force top_level_proj_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file top_level_proj_drc_routed.rpt -pb top_level_proj_drc_routed.pb -rpx top_level_proj_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file top_level_proj_methodology_drc_routed.rpt -pb top_level_proj_methodology_drc_routed.pb -rpx top_level_proj_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file top_level_proj_power_routed.rpt -pb top_level_proj_power_summary_routed.pb -rpx top_level_proj_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file top_level_proj_route_status.rpt -pb top_level_proj_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file top_level_proj_timing_summary_routed.rpt -pb top_level_proj_timing_summary_routed.pb -rpx top_level_proj_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file top_level_proj_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file top_level_proj_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file top_level_proj_bus_skew_routed.rpt -pb top_level_proj_bus_skew_routed.pb -rpx top_level_proj_bus_skew_routed.rpx"
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force top_level_proj_routed_error.dcp
...
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO} [current_project]
  catch { write_mem_info -force -no_partial_mmi top_level_proj.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force top_level_proj.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force top_level_proj}
  catch {file copy -force top_level_proj.ltx debug_nets.ltx}
