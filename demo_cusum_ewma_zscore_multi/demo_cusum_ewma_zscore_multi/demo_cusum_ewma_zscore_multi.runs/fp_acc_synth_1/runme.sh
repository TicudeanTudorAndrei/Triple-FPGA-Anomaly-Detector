...
HD_PWD='E:/VivadoProjects/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi.runs/fp_acc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_acc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_acc.tcl
