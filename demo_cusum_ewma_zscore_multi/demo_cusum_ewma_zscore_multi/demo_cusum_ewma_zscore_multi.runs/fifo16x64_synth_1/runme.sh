...
HD_PWD='E:/VivadoProjects/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi/demo_cusum_ewma_zscore_multi.runs/fifo16x64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo16x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo16x64.tcl
