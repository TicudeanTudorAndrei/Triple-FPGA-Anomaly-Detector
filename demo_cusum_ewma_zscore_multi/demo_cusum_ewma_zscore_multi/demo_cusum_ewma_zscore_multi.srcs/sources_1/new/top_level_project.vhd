...
constant CUSUM_THR: STD_LOGIC_VECTOR(31 downto 0) := x"00000190"; -- 400
constant CUSUM_DRIFT: STD_LOGIC_VECTOR(31 downto 0) := x"00000064"; -- 100

constant ALPHA_HEX: STD_LOGIC_VECTOR(31 downto 0) := x"3c23d70a";   -- 0.01 (balanced smoothing and overall < 1)                             
constant P_HEX : STD_LOGIC_VECTOR(31 downto 0) := x"40200000";      -- 2.5  (250% over EWMA is anomaly)          
constant S0_HEX: STD_LOGIC_VECTOR(31 downto 0) := x"3fc00000";      -- 1.5 (first EWMA - S0, depending on input nature)
...
ALPHA_HEX: STD_LOGIC_VECTOR(31 downto 0) := x"3c23d70a"; -- 0.01
P_HEX: STD_LOGIC_VECTOR(31 downto 0) := x"3f800000"; -- 1
...
begin
    if rising_edge(clk) then
        ...
        if zscore_anomaly_tvalid = '1' then
            display_data_7seg <= display_data_7seg_filler & zscore_anomaly_tdata;
            send_data <= send_filler & zscore_anomaly_id & zscore_anomaly_tdata(0) & send_flag_zscore;
            send_valid <= '1';
        end if;
        
        if ewma_anomaly_tvalid = '1' then
            display_data_7seg <= display_data_7seg_filler & ewma_anomaly_tdata;
        ...
        if cusum_anomaly_tvalid = '1' then
            ...
            display_data_7seg <= display_data_7seg_filler & cusum_anomaly_tdata_reduced;
